...
Excluding a commercial project, we take Gramatron and Superion as extension targets that can generate our test file formats.
...
If the novel defect(s) are discovered and notable, we will consider the ancillary goal of drafting a manuscript and publishing it in an appropriate journal after the semester ends.
